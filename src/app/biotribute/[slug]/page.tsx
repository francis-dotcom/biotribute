            ...
            <article className="form-card support-actions-card">
              ...
              <div className="support-action-list">
                <button className="support-action-pill" type="button">
                  <span aria-hidden="true">🌸</span>&nbsp;Flowers
                </button>
              ...
              <p className="support-actions-copy">
                Send a heart to show love and support. Contributions can help with
                memorial costs, family support, or any purpose the page owner defines.
              </p>
            </article>
            <article className="form-card">
              ...
              <p>
                {tribute.supportNote?.trim()
                  ? tribute.supportNote
                  : "For the production version, connect this section to Stripe Checkout or Payment Links. For tomorrow's launch, this layout is ready to be wired to a real support flow."}
              </p>
            </article>
          </div>
        </section>
