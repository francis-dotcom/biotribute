...
grant select, insert, update, delete on table public.tribute_messages to service_role;
...
grant select, insert, update, delete on table public.family_private_messages to service_role;
